...
inline std::string ConventionWorkerLibPath(const ArmoniK::Sdk::Common::Configuration &config) {
...
public:
  void HandleResponse(std::string &&result_payload, const std::string &taskId, const std::string &result_id) override;
...
public:
  ...
  void HandleResponse(std::string &&result_payload, const std::string &taskId, const std::string &result_id) final;
