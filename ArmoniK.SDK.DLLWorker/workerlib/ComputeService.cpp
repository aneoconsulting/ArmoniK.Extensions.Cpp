...
SDK_WORKER_NAMESPACE::ComputeService::Process(ArmoniK::Api::Worker::TaskHandler &task_handler) {
 ...
 * @return std::string
 */
std::string SDK_WORKER_NAMESPACE::ServiceContext::getServiceName() { return service_name_; }
 ...
 * @return std::string
 */
std::string SDK_WORKER_NAMESPACE::ServiceContext::getApplicationName() { return application_name_; }
 ...
 * @return std::string
 */
std::string SDK_WORKER_NAMESPACE::ServiceContext::getNamespace() { return app_namespace_; }
 ...
 * @return std::string
 */
std::string SDK_WORKER_NAMESPACE::SessionContext::getSessionId() { return session_id_; }
 ...
 */
SDK_WORKER_NAMESPACE::ServiceContext *
SDK_WORKER_NAMESPACE::ApplicationManager::CreateService(ServiceContext service_context) {
  service_context_ =
      (SDK_WORKER_NAMESPACE::ServiceContext *)armonik_create_service(service_context.getServiceName().c_str());
 ...
 */
SDK_WORKER_NAMESPACE::SessionContext *
SDK_WORKER_NAMESPACE::ApplicationManager::EnterSession(SessionContext session_context) {
  session_context_ = (SDK_WORKER_NAMESPACE::SessionContext *)armonik_enter_session(
      &session_context, session_context.getSessionId().c_str());
...
void SDK_WORKER_NAMESPACE::ApplicationManager::Execute(ServiceContext service_context, SessionContext session_context) {
  armonik_call(&service_context, &session_context, service_context.getApplicationName().c_str(),
               service_context.getApplicationName().c_str(), service_context.getApplicationName().size(),
               SDK_WORKER_NAMESPACE::ApplicationManager::CallbackFunc);
}
 ...
 * @param session_context
 */
void SDK_WORKER_NAMESPACE::ApplicationManager::LeaveSession(ServiceContext service_context,
