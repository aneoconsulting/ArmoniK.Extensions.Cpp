function(setup_options project_name_param)
    ...
    if(MSVC)
        ...
        if(IS_ALPINE EQUAL -1)
            target_compile_options(${project_name_param} PRIVATE -Wall -Wextra -Wpedantic -pedantic-errors $<$<CONFIG:Debug>:-fsanitize=undefined,address> ${extra_param})
        else ()
            target_compile_options(${project_name_param} PRIVATE -Wall -Wextra -Wpedantic -pedantic-errors ${extra_param})
        endif()
    endif()
    ...
    set_property(TARGET ${project_name_param} PROPERTY CXX_STANDARD 11)
