function(setup_options project_name_param)
    ...
    if(MSVC)
        ...
        if(IS_ALPINE EQUAL -1)
            target_compile_options(${project_name_param} PRIVATE -Wall -Wextra -std=c++14 -pedantic-errors $<$<CONFIG:Debug>:-fsanitize=undefined,address> ${extra_param})
        else ()
            target_compile_options(${project_name_param} PRIVATE -Wall -Wextra -std=c++14 -pedantic-errors ${extra_param})
        endif()
    endif()
