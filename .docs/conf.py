...
project = "ArmoniK.Extensions.Cpp"
...
extensions = ["myst_parser", 'sphinxcontrib.mermaid', 'breathe']
...
breathe_projects = {
    "ArmoniK.Extensions.Cpp": "content/cpp/doxygen/xml"
}
breathe_default_project = "ArmoniK.Extensions.Cpp"

# -- Options to show "Edit on GitHub" button ---------------------------------
html_context = {
    "display_github": True, # Integrate GitHub
    "github_user": "aneoconsulting", # Username
    "github_repo": "ArmoniK.Extensions.Cpp", # Repo name
